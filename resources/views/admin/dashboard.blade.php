                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="metric-value d-inline-block">
                                <h1 class="mb-1">{{$total_reservation_last_30}}</h1>
                            </div>
                                ...
                                <table class="table">
                                    <thead class="bg-light">
                                        <tr class="border-0">
                                            ...
                                            <th class="border-0">Total Guest</th>
                                    ...
                                    <tbody>
                                        @foreach ($latestReservations as $reservation)
                                            <tr>
                                                ...
                                                @if ($reservation->guest_total > 2)
                                                <td><span class="badge-dot badge-success mr-1"></span>Booth</td>
                                                @else
                                                <td><span class="badge-dot badge-brand mr-1"></span>Bar</td>
                                                @endif
                                            </tr>
                                        @endforeach
                                        <tr>
